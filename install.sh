...
ln -s $INSTALL_DIR/packet_forwarder_legacy/poly_pkt_fwd/poly_pkt_fwd ./bin/poly_pkt_fwd
cp -f ./packet_forwarder_legacy/poly_pkt_fwd/global_conf.json ./bin/global_conf.json
